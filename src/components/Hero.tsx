...
export default function Hero({ onPlanSelect, onScrollToPlans }: HeroProps) {
  ...
  // Hardcoded image generated by our system
  const heroImageSrc = "/src/assets/images/laptop_server_isometric_mockup_1780267375819.png";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="lg:col-span-8 bg-white rounded-3xl p-6.5 sm:p-10 md:p-12 border border-purple-100 shadow-[0px_4px_16px_rgba(103,61,230,0.08)] flex flex-col justify-center text-left space-y-6 md:space-y-8 z-10 transition-transform duration-300 hover:translate-y-[-2px]">
            <div className="inline-flex items-center gap-2 bg-[#EDE9FE] border border-[#C4B5FD] px-3.5 py-1.5 rounded-full w-fit">
              <Languages className="w-4 h-4 text-[#2F1C6A]" />
              <span className="text-[11px] font-extrabold text-[#2F1C6A] tracking-wider uppercase font-mono">
                PREMIUM HOSTING &bull; 24/7 தமிழ் ஆதரவு
              </span>
            </div>

            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black text-[#2F1C6A] tracking-tight leading-[1.1] md:leading-[1.15]">
              From Your First Blog to <strong className="text-[#673DE6] font-extrabold">1 Lakh Visitors/Day</strong> — Hosting That Grows With You
            </h1>

            <p className="text-[#2F1C6A]/80 text-base md:text-lg max-w-xl font-normal leading-relaxed">
              Start at ₹59/mo. Upgrade anytime. Free Migration + 24/7 WhatsApp Support in <span className="text-[#673DE6] font-bold">Tamil</span>.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
              ...
              <button
                ...
                className="bg-[#673DE6] hover:bg-[#5025D1] text-white font-bold text-[16px] px-8 py-4 rounded-[8px] shadow-lg hover:-translate-y-0.5 active:translate-y-0 transition-all text-center cursor-pointer flex items-center justify-center gap-1"
              >
                <span>View Pricing Plans →</span>
              </button>
            </div>

            {/* Trust check bar / Icon List */}
            <div className="flex flex-wrap items-center gap-x-5 gap-y-2 text-[#2F1C6A]/80 text-xs pt-2 font-bold font-sans">
              <div className="flex items-center gap-1.5 bg-purple-50/60 px-2.5 py-1.5 rounded-full border border-purple-100/50">
